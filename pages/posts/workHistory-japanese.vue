<template>
    ...
    <section>
      ...
      <ul>
        ...
        <li>HTML、CSS、および React.js、Next.js、Vue.js、Nuxt.js、Angularなどのフレームワークを使用して、コンポーネントを含む ウエブサイトを作成します</li>
        <li>Redux、Vuex、Zustand等の状態管理ライブラリを用いた開発経験があります</li>
      ...
      <ul>
        ...
        <li>新しい教師にさまざまな教育アプローチとアイデアを紹介しました。例えば、<a href="https://www.aeseducation.com/blog/what-are-21st-century-skills">21世紀のスキル</a>、<a href="https://www.habitsofmindinstitute.org/wp-content/uploads/2018/10/HabitsofTheMindChartv2.pdf">ハビット オブ マインド</a>、どうやって子供に科学的な考え方、問題解決能力を教えることです。</li>
      </ul>
      ...
      <ul>
        <li>結果と教師からのフィードバックに基づいてカリキュラム基準を評価し、調整します</li>
        <li>生徒向けのテストと教師向けのサポート文書を作成します</li>
        <li>新しい通知表の見た目と内容を計画、デザイン、作成します</li>
        <li>教科書、教材、テクノロジー、学習アプローチをレビューして推奨します</li>
        <li>教師を観察して評価し、フィードバックを提供します</li>
        <li>生徒のテスト結果を分析および解釈します</li>
        <li>研修を企画、開催、実施します</li>
        <li>新しい候補者にインタビューし、デモレッスンを評価します</li>
        <li>新しい教師を会社に迎え入れ、継続的な研修と定期的な会議を通じて、その役割と職務へのスムーズな移行を確保します</li>
      </ul>
      <div>
        <h3>ヘッド・ティーチャーの責任:</h3>
      <ul>
        <li>新しい教師の管理、研修、評価、育成します</li>
        <li>学校のイベント、旅行、会議の計画を整理します</li>
        <li>学校での責任を職員に委任します</li>
        <li>学校の方針と規則を確保し、維持します</li>
        <li>学校に教育ビジョンを提供します</li>
        <li>教師に教育リソース、イノベーション、テクノロジーを提供します</li>
        <li>顕微鏡、ソーラーパネル、電気回路、コンピューター アプリケーション、 <a href="https://workspace.google.com/">Google Workspace</a>等、色々なテクノロジーの使用方法について教師に教えます</li>
        <li>生徒とスタッフの両方にとって、前向きで組織的でやりがいのある教育および学習環境を作成して維持します</li>
        <li>学校内の問題について職員、生徒、保護者の意見を聞き、それに応じて対応します</li>
        <li>学校とその運営の全般的な監督を行います</li>
      </ul>
      </div>
      </div>
      <div><h3>担任教師の責任:</h3>
      <ul>
        <li>英語、算数、理科、美術、社会、音楽、体育、<a href="https://www.pblworks.org/what-is-pbl">プロジェクトベストラーニング</a>、<a href="https://www.britannica.com/video/193418/overview-STEM-education">STEM</a>、<a href="https://www.ictesolutions.com.au/blog/why-schools-should-invest-in-ict/">ICT</a>の授業を計画、実施します</li>
        ...
        <li>三者面談、Eメールのやり取り、ミーティングを通じて保護者とコミュニケーションをとります
        <li>学生のパフォーマンス、サイエンスプレゼンテーション、聴衆の前でのステージ上でのスピーチを指導し、監督します</li>
      </ul>
      </div>
      </section>
      <section>
      ...
      <h3>責任:</h3>
       <ul>
        <li>小学校の英語の授業の企画・準備・実施しました</li>
        <li>中学校の英語の授業の企画・準備・実施、およびチームティーチングしました</li>
        <li>中学校のテストの採点を手伝いました</li>
        <li>英語のスピーキングテストとリスニングテストを行いました</li>
        <li>放課後英語クラブに参加し、監督を務めました</li>
        <li>毎週の教師研修とミーティングセッションに参加しました</li>
        <li>英語の教え方を小学校の教師に見せて、相談しました</li>
        <li>文化大使として務め、学生に異文化について紹介しました</li>
        <li>生徒の学習に対する情熱と、英語や他の文化について学ぶことへの関心を育みました</li>
        <li>体育祭の企画・準備・実施を手伝いました</li>
      </ul>
      </section>
    </div>
</template>
